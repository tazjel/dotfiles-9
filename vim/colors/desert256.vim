...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    "DiffText
    "ErrorMsg
    call <SID>X("VertSplit", "5c5d5e", "acadae", "reverse")
    ...
    call <SID>X("StatusLine", "5c5d5e", "acadae", "")
    call <SID>X("StatusLineNC", "5c5d5e", "acadae", "reverse")
    call <SID>X("TabLine", "acadae", "5c5d5e", "none")
    call <SID>X("TabLineSel", "acadae", "5c5d5e", "bold")
    call <SID>X("TabLineFill", "5c5d5e", "acadae", "")
    ...
    "Error
    call <SID>X("Todo", "87ceeb", "", "bold,underline")

    call <SID>X("SpellBad", "cd5c5c", "", "bold,underline")
    call <SID>X("SpellCap", "5c5ccd", "", "bold,underline")
    call <SID>X("SpellRare", "5ccd5c", "", "bold,underline")
